...
void GraphicsViewPannable::mousePressEvent(QMouseEvent* event)
{
...
void GraphicsViewPannable::mouseMoveEvent(QMouseEvent* event)
{
...
void GraphicsViewPannable::mouseReleaseEvent(QMouseEvent* event)
{
